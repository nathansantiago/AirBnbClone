// List of perks on the new accomodation page

export default function Perks({selected, onChange}) {
    function handleCbClick(ev) {
        const {checked, name} = ev.target; // Grabs checked boolean and name from each checked item
        if (checked) {
            onChange([...selected, name]);
        } else {
            onChange([...selected.filter(selectedName => selectedName !== name)]) // Filters out name if it is deselected
        }
    }
    return(
        <>
