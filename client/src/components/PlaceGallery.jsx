...
export default function PlaceGallery ({place}) {
    ...
    // Shows all photos in popup
    if (showAllPhotos) {
        return (
            // Creates white overlay on whole screen
            // Inset streches from top left to bottom right
            <div className="absolute inset-0 bg-black text-white">
                <div className="p-8 bg-black grid gap-4">
                    {/* Close button */}
                    <div>
                        <h2 className="text-3xl mr-48">Photos of {place.title}</h2>
                        {/* Fixed keeps button in same place even while scrolling */}
                    ...
                    {/* If there are photos map them to the div */}
        ...
        <div className="relative">
            <div className="grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden">
                <div>
                    {place.photos?.[0] && (
                        <div>
                            {/* Need to fix image to fill container. */}
